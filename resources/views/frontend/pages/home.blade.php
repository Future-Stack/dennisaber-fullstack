...
@section('contents')
    <main class="portal-home">
        <div class="portal-notice"><strong>Technisches Kursportal</strong><span>Keine Bestellung auf dieser Website. <a
                    href="{{ url('/') }}">Kurse im Verkaufsportal ansehen →</a></span>
        </div>
        ...
        <section class="portal-hero">
            ...
            <div class="portal-hero-copy"><p>Jeder Kurs besitzt eine eigene Landingpage, einen eigenen persönlichen
                    Zugang
                    und einen geschützten Kursbereich.</p>
                <div><a href="#academy">11 Kurse <b>↓</b></a>
        ...
        <section class="access-terms" id="laufzeiten">
            ...
            <div>
                <article><span>Reguläre Kurse</span><strong>Drei Monate</strong>
                    <p>Ab der individuellen Freischaltung.</p><a href="#">Zum Fünf-Tage-Kurs →</a>
                </article>
                <article><span>Rio Negro 2002</span><strong>30 Tage</strong>
                    <p>Einzige Ausnahme für das Abenteuer für 24,90 €.</p><a href="#">Zum
                        Abenteuer
                        →</a></article>
                <article><span>Für alle Kurse</span><strong>Kein Abo</strong>
                    <p>Keine automatische Verlängerung und keine weitere Abbuchung.</p><a href="#bezahlung">So
                        funktioniert
        ...
        <section class="course-catalog" id="kurse">
            <section class="catalog-group cat-academy" id="academy">
                ...
                <div class="catalog-grid"><a href="#" class="catalog-card"><p>DNL-Akademie</p>
                        ...
                        <div class="catalog-card-bottom"><strong>490 €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a><a href="#" class="catalog-card"><p>DNL-Akademie</p>
                        ...
                        <div class="catalog-card-bottom"><strong>1.490
                                €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a></div>
            </section>
            <section class="catalog-group cat-prevention" id="prevention">
                ...
                <div class="catalog-grid"><a href="#" class="catalog-card"><p>Gesund
                            Voraus</p>
                        ...
                        <div class="catalog-card-bottom"><strong>199 €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a><a href="#" class="catalog-card"><p>Gesund Voraus</p>
                        <h3>Rauchfrei</h3>
                        <div class="catalog-card-bottom"><strong>199 €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a><a href="#" class="catalog-card"><p>Gesund Voraus</p>
                        ...
                        <div class="catalog-card-bottom"><strong>199 €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a><a href="#" class="catalog-card"><p>Psychologie &amp; Prävention</p>
            ...
            <section class="catalog-group cat-business" id="business">
                ...
                <div class="catalog-grid"><a href="#" class="catalog-card"><p>Business</p>
                        <h3>Erfolgreich gründen</h3>
                        <div class="catalog-card-bottom"><strong>1.690
                                €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a><a href="#" class="catalog-card"><p>Erlebte Medienpraxis</p>
                        ...
                        <div class="catalog-card-bottom"><strong>390 €</strong><span>Drei Monate ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a><a href="#" class="catalog-card"><p>Wirkung</p>
            ...
            <section class="catalog-group cat-adventure" id="adventure">
                ...
                <div class="catalog-grid"><a href="#" class="catalog-card"><p>
                            Audio-Abenteuer</p>
                        <h3>Rio Negro 2002</h3>
                        <div class="catalog-card-bottom"><strong>24,90
                                €</strong><span>30 Tage ab Freischaltung</span><b>Landingpage
                                öffnen →</b></div>
                    </a></div>
            </section>
        </section>
        <section class="portal-principles">
            ...
            <div class="principle-grid">
                <article><span>01</span>
                    ...
                    <p>Beratung, Leistungsbeschreibung und Buchung erfolgen ausschließlich auf besseler.de.</p>
                </article>
                <article><span>02</span>
                    ...
                    <p>Bereits freigeschaltete Kunden gelangen mit Benutzername und Passwort direkt in ihren gebuchten
                        Kurs.</p><a href="#">Zum aktuellen Kundenlogin →</a></article>
                <article><span>03</span>
                    <h3>Geschützter Kursbereich</h3>
                    <p>Hier werden die von uns bereitgestellten Kursinhalte technisch ausgeliefert und der
                        Bearbeitungsstand
        ...
        <section class="payment-process" id="bezahlung">
            ...
            <div class="payment-note"><p><strong>Dieses Portal verkauft nichts:</strong> Es stellt ausschließlich die
                    von
                    uns erbrachte technische Kursleistung für bereits freigeschaltete Kunden bereit.</p>
                <div class="payment-note-links"><a
                        href="{{ url('/') }}">Zum Verkaufsportal
                        →</a><a
                        href="{{ route('payment') }}">Hinweise für bestehende Rechnungen →</a></div>
            </div>
        </section>
