    ...
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                ...
                <h1>Rauchfrei</h1>
                <p class="course-lead">Schritt für Schritt rauchfrei leben. Verhaltenstherapeutisch fundiertes Programm für dauerhafte Tabak- und Nikotinfreiheit.</p>
                ...
                <a class="order-cta" href="{{ route('course.show', 'rauchfrei') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
