    ...
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">Gesund Voraus · digitales Selbstlernprogramm</p>
                <h1>Rauchfrei</h1>
                <p class="course-lead">Nicht nur aufhören. Verstehen, welche Situationen, Rituale und Abläufe das Rauchen
                    bisher stabilisieren.</p>
        ...
        <section class="course-details">
            <div class="course-intro"><p class="eyebrow">Der vollständige Leistungsrahmen</p>
                ...
                <blockquote>Geführte Selbstarbeit ohne Heil- oder Erfolgsversprechen.</blockquote>
            </div>
            <dl class="facts-grid">
                <div>
                    <dt>Arbeitsweise</dt>
        ...
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>Ausgangslage und Rauchstopptermin klären</li>
                    <li>Auslöser und Abhängigkeit realistisch einschätzen</li>
                    <li>Wenn-dann-Pläne für kritische Situationen entwickeln</li>
                    <li>Erste Tage und den Abend vor dem Rauchstopp vorbereiten</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>A01</span>
                    <h3>Ankommen und Rauchstopptermin</h3></article>
                <article><span>A02</span>
                    <h3>Deine Ausgangslage</h3></article>
                <article><span>A03a</span>
                    <h3>Dein Vier-Tage-Protokoll</h3></article>
                <article><span>A03b</span>
                    <h3>Deine Startphase abschließen</h3></article>
            </div>
        </section>
