    ...
    <main class="course-landing cat-academy">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                <p class="eyebrow">DNL-Akademie · Bildungsurlaub</p>
                <h1>5-Tage-Kompaktlehrgang</h1>
                <p class="course-lead">Kompakte Qualifikation &amp; praxisnahe Methodik. In fünf Tagen die wesentlichen Werkzeuge für Führung, strukturierte Kommunikation und persönliche Wirksamkeit erarbeiten.</p>
                <div class="course-price"><strong>490 €</strong><span>einmalig · kein Abo</span></div>
                ...
                <a class="order-cta" href="{{ route('course.show', 'dnl-kompakt') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
        ...
        <section class="course-details">
            <div class="course-intro">
                ...
                <h2>Was dieser Lehrgang konkret leistet.</h2>
                <blockquote>Dennis Besseler vermittelt strukturierte Gesprächsführung und lösungsorientierte Interventionen aus langjähriger Praxis.</blockquote>
            </div>
            <dl class="facts-grid">
                <div>
                    <dt>Umfang</dt>
                    <dd>5 Tage · 5 strukturierte Module</dd>
                </div>
                <div>
                    <dt>Arbeitsmaterial</dt>
                    <dd>Arbeitsblätter &amp; Reflexionsbögen (PDF)</dd>
                </div>
                <div>
                    <dt>Abschluss</dt>
                    <dd>Teilnahmebescheinigung nach 100% Abschluss</dd>
                </div>
                <div>
                    <dt>Laufzeit</dt>
