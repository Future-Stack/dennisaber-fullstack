    ...
    <main class="course-landing cat-business">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                <p class="eyebrow">Kommunikation &amp; Wirkung</p>
                <h1>Rhetorik unter Druck</h1>
                <p class="course-lead">Souverän argumentieren in schwierigen Verhandlungssituationen. Schlagfertigkeit, Körpersprache und Deeskalationstechniken in anspruchsvollen Gesprächen.</p>
                ...
                <a class="order-cta" href="{{ route('course.show', 'rhetorik-unter-druck') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
