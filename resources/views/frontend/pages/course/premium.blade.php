...
@section('contents')
    <main class="course-landing cat-academy">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">DNL-Akademie · persönliche Begleitung</p>
                <h1>Premium mit Direktkontakt</h1>
                <p class="course-lead">Die vollständige Ausbildung mit Executive Workbook und persönlichem
                    WhatsApp-Direktkontakt.</p>
                <div class="dnl-brand-graphic"><img src="../dnl-master.svg"
                                                    alt="Dennis-Navigationslogik: Wahrnehmen, Einordnen, Entscheiden, Handeln"/>
                </div>
                <div class="course-price"><strong>1.490 €</strong><span>einmalig · kein Abo</span></div>
        ...
        <section class="course-details">
            <div class="course-intro"><p class="eyebrow">Der vollständige Leistungsrahmen</p>
                <h2>Für wen und in welchem Rahmen.</h2>
                <p>Führungskräfte und Entscheider, die zusätzlich zur geführten Durcharbeitung persönlichen Kontakt
                    wünschen.</p></div>
            <dl class="facts-grid">
                <div>
                    <dt>Umfang</dt>
                    <dd>30 Audioeinheiten</dd>
                </div>
                <div>
                    <dt>Arbeitsmaterial</dt>
                    <dd>Executive Workbook, digital</dd>
                </div>
                <div>
                    <dt>Zeitrahmen</dt>
                    <dd>ca. 30 Stunden, frei einteilbar</dd>
                </div>
                <div>
                    <dt>Transfer</dt>
                    <dd>Transferplan plus persönlicher Direktkontakt</dd>
                </div>
                <div>
                    <dt>Verlängerung</dt>
                    <dd>Keine; automatische Deaktivierung</dd>
                </div>
            </dl>
        </section>
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>Vollständige Dennis-Navigationslogik</li>
                    <li>Executive Workbook</li>
                    <li>Methodische Rückfragen direkt an Dennis</li>
                    <li>Transfer in die konkrete Situation</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>Wahrnehmen</span>
                    <h3>Eigene Situation klären</h3></article>
                <article><span>Einordnen</span>
                    <h3>Fragen direkt zuspitzen</h3></article>
                <article><span>Entscheiden</span>
                    <h3>Methode anwenden</h3></article>
                <article><span>Handeln</span>
                    <h3>Transfer mit Direktkontakt</h3></article>
            </div>
        </section>
