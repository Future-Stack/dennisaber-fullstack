    ...
    <main class="course-landing cat-academy">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                ...
                <h1>Premium-Seminar</h1>
                <p class="course-lead">Exklusives Intensivseminar für Führungskräfte und Entscheidungsträger. Systemische Analyse, strategische Ausrichtung und persönliche Begleitung.</p>
                ...
                <a class="order-cta" href="{{ route('course.show', 'dnl-premium') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
