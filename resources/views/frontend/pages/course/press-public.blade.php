    ...
    <main class="course-landing cat-business">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                <p class="eyebrow">Eigenständige Vertiefung</p>
                <h1>Presse &amp; Öffentlichkeit</h1>
                <p class="course-lead">In drei Tagen aus dem eigenen realen Thema eine arbeitsfähige Presseansprache entwickeln – sachlich, relevant und ohne Scheingarantie auf Veröffentlichung.</p>
                ...
                <a class="order-cta" href="{{ route('course.show', 'presse-oeffentlichkeit') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
