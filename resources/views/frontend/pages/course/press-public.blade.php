    ...
    <main class="course-landing cat-business">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">Eigenständige Vertiefung</p>
                ...
                <p class="course-lead">In drei Tagen aus dem eigenen realen Thema eine arbeitsfähige Presseansprache
                    entwickeln – sachlich, relevant und ohne Scheingarantie auf Veröffentlichung.</p>
                <div class="course-price"><strong>390 €</strong><span>einmalig · kein Abo</span></div>
        ...
        <section class="course-details">
            <div class="course-intro"><p class="eyebrow">Der vollständige Leistungsrahmen</p>
                ...
                <blockquote>Dennis Besseler vermittelt Pressearbeit aus eigener Medienerfahrung – nicht aus einem
                    Lehrbuch.
                </blockquote>
            </div>
            <dl class="facts-grid">
                <div>
                    <dt>Umfang</dt>
                    <dd>3 Tage · 24 kurze Einheiten</dd>
                </div>
                <div>
                    <dt>Arbeitsmaterial</dt>
                    <dd>Arbeitsbuch am eigenen Projekt</dd>
                </div>
                <div>
                    <dt>Ergebnis</dt>
                    <dd>Pressemitteilung, Pitch und Verteiler</dd>
                </div>
                <div>
                    <dt>Verlängerung</dt>
        ...
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>A01–A24: kurze Audio-Einheiten von meist drei bis fünf Minuten</li>
                    <li>Pressemitteilung, Ansprache und Verteiler am eigenen Projekt entwickeln</li>
                    <li>Nachrichtenwert, Timing und redaktionelle Relevanz kritisch prüfen</li>
                    <li>Vor Veröffentlichung rechtliche und kommunikative Risiken screenen</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>Tag 1</span>
                    <h3>Verstehen und zuspitzen</h3></article>
                <article><span>Tag 2</span>
                    <h3>Material und Ansprache</h3></article>
                <article><span>Tag 3</span>
                    <h3>Prüfen und nachbereiten</h3></article>
                <article><span>Ergebnis</span>
                    <h3>Arbeitsfähige Presseansprache</h3></article>
            </div>
        </section>
