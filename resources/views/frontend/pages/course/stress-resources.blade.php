...
@section('contents')
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">Gesund Voraus · digitales Selbstlernprogramm</p>
                <h1>Stress und Ressourcen</h1>
                <p class="course-lead">Belastungen erkennen, persönliche Ressourcen gezielt einsetzen und einen tragfähigen
                    Umgang mit Stress entwickeln.</p>
        ...
        <section class="course-details">
            <div class="course-intro"><p class="eyebrow">Der vollständige Leistungsrahmen</p>
                ...
                <blockquote>Das Programm organisiert konkrete Selbstbeobachtung und Alltagstransfer – ohne
                    Erfolgsversprechen.
                </blockquote>
            </div>
            <dl class="facts-grid">
                ...
                <div>
                    ...
                    <dd>Digitales Arbeitsbuch</dd>
                </div>
                <div>
                    <dt>Ausrichtung</dt>
                    <dd>Selbstbeobachtung und Alltagstransfer</dd>
                </div>
                <div>
                    <dt>Verlängerung</dt>
        ...
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>Persönliche Belastungen und Auslöser wahrnehmen</li>
                    <li>Ressourcen nicht nur kennen, sondern gezielt einsetzen</li>
                    <li>Konkrete Übertragung auf den eigenen Alltag</li>
                    <li>Geführte Selbstarbeit statt Behandlung oder Coaching</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>P01</span>
                    <h3>Einstieg und Orientierung</h3></article>
                <article><span>P02</span>
                    <h3>Belastung verstehen</h3></article>
                <article><span>P03</span>
                    <h3>Ressourcen erkennen</h3></article>
                <article><span>Transfer</span>
                    <h3>Eigenes Ressourcensystem anwenden</h3></article>
            </div>
        </section>
