    ...
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                <p class="eyebrow">Psychologie &amp; Prävention</p>
                <h1>Klar entscheiden</h1>
                <p class="course-lead">Entscheidungskompetenz in komplexen Lagen. Systematische Entscheidungsfindung unter Zeitdruck, Unsicherheit und widerstreitenden Interessen.</p>
                ...
                <a class="order-cta" href="{{ route('course.show', 'klar-entscheiden') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
