...
@section('contents')
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">Psychologie · digitaler 1-Tages-Entscheidungskurs</p>
                <h1>Klar entscheiden, wenn andere mitentscheiden.</h1>
                <p class="course-lead">Du führst eine reale Entscheidung von der Benennung über Einfluss, Fakten und eigene
                    Kriterien bis zur sichtbaren Handlung und zu deinem persönlichen Entscheidungssystem.</p>
        ...
        <section class="course-details">
            <div class="course-intro"><p class="eyebrow">Der vollständige Leistungsrahmen</p>
                ...
                <blockquote>Keine Therapie, Diagnose oder medizinische, rechtliche, steuerliche oder finanzielle Beratung.
                </blockquote>
            </div>
            <dl class="facts-grid">
                <div>
                    <dt>Umfang</dt>
                    <dd>Acht klare Audioführungen</dd>
                </div>
                <div>
                    <dt>Arbeitsmaterial</dt>
                    <dd>Ausfüllbares digitales Arbeitsbuch</dd>
                </div>
                <div>
                    <dt>Zeitrahmen</dt>
                    <dd>Ein vollständiger Arbeitstag</dd>
                </div>
                <div>
                    <dt>Ergebnis</dt>
                    <dd>Konkrete Handlung und Prüftermin</dd>
                </div>
            </dl>
        </section>
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>Die Entscheidung benennen</li>
                    <li>Einfluss sichtbar machen</li>
                    <li>Fakten, Deutungen, Prognosen und Interessen trennen</li>
                    <li>Eigene Kriterien zurückgewinnen</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>A01–A02</span>
                    <h3>Entscheidung und Einfluss</h3></article>
                <article><span>A03–A04</span>
                    <h3>Fakten und eigene Kriterien</h3></article>
                <article><span>A05–A06</span>
                    <h3>Wahrnehmen und ausreichend sicher entscheiden</h3></article>
                <article><span>A07–A08</span>
                    <h3>Handeln und persönliches System sichern</h3></article>
            </div>
        </section>
