    ...
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                <p class="eyebrow">Gesund Voraus · Prävention</p>
                <h1>Ernährung</h1>
                <p class="course-lead">Gesunde Ernährung im Alltag etablieren. Praktischer Leitfaden für alltagstaugliche und typgerechte Ernährungsoptimierung ohne Verzichtsdogmen.</p>
                ...
                <a class="order-cta" href="{{ route('course.show', 'ernaehrung') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
