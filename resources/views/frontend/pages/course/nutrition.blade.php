    ...
    <main class="course-landing cat-prevention">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">Gesund Voraus · digitales Selbstlernprogramm</p>
                <h1>Ernährung</h1>
                <p class="course-lead">Keine kurzfristige Diät. Gewohnheiten, Auslöser und Entscheidungen erkennen und
                    daraus ein persönliches Ernährungssystem entwickeln.</p>
        ...
        <section class="course-details">
            ...
            <dl class="facts-grid">
                ...
                <div>
                    <dt>Ausrichtung</dt>
                    <dd>Persönliches Ernährungssystem</dd>
                </div>
                <div>
                    <dt>Verlängerung</dt>
        ...
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>Essimpulse und Ausgangslage beobachten</li>
                    <li>Restaurants und Ausnahmen bewusst einordnen</li>
                    <li>Stress als Auslöser erkennen</li>
                    <li>Nach Abweichungen gezielt ins System zurückkehren</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>E01-A01</span>
                    <h3>Willkommen und Kurslogik</h3></article>
                <article><span>E01-A02</span>
                    <h3>Sicherheit und Teilnahme</h3></article>
                <article><span>E01-A03</span>
                    <h3>Dennis Geschichte und DNL</h3></article>
                <article><span>E01-A04</span>
                    <h3>Ausgangsanalyse starten</h3></article>
            </div>
        </section>
