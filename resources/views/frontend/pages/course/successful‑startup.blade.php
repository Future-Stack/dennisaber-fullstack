...
@section('contents')
    <main class="course-landing cat-adventure">
        ...
        <section class="course-hero">
            <div class="course-hero-copy"><p class="eyebrow">Wahres Audio-Abenteuer für Erwachsene</p>
                <h1>Erst erleben. Dann entscheiden.</h1>
                <p class="course-lead">Hören Sie die erste Etappe, blättern Sie im Expeditionsbuch und entscheiden Sie
                    selbst, wie Sie aufbrechen würden.</p>
                <div class="course-price"><strong>24,90 €</strong><span>einmalig · kein Abo</span></div>
                <div class="access-badge"><b>Persönlicher Kurszugang</b><span>30 Tage ab Freischaltung</span><small>Kein
                ...
                <a class="order-cta" href="../../besseler-kursvorschau.dennis-bes.chatgpt.site/angebote/index.html">Kurs im
                    Verkaufsportal ansehen <span>→</span></a><a href="../service/rio-negro.html" class="service-cta"><span>Bereits bestellt oder überwiesen?</span><strong>Schnellere
                        Bearbeitung →</strong></a></div>
        ...
        <section class="course-details">
            <div class="course-intro"><p class="eyebrow">Der vollständige Leistungsrahmen</p>
                ...
                <blockquote>Wahre Geschichte hören, selbst entscheiden und danach erfahren, wie Dennis tatsächlich
                    handelte.
                </blockquote>
            </div>
            <dl class="facts-grid">
        ...
        <section class="course-content">
            <div><p class="eyebrow">Inhalte und Ergebnis</p>
                ...
                <ul>
                    <li>ohne Registrierung und ohne E-Mail-Adresse ausprobieren</li>
                    <li>keine Kaufpflicht nach der Probe</li>
                    <li>PDF bleibt separat vollständig öffnbar</li>
                    <li>basierend auf einer tatsächlich erlebten Expedition</li>
                </ul>
            </div>
            <div class="module-list">
                <article><span>01</span>
                    <h3>Einführung</h3></article>
                <article><span>02</span>
                    <h3>Die erste Etappe</h3></article>
                <article><span>03</span>
                    <h3>Die Fortsetzung</h3></article>
                <article><span>04</span>
                    <h3>Der Abschluss</h3></article>
            </div>
        </section>
