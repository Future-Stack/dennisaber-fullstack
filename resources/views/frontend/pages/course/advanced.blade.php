    ...
    <main class="course-landing cat-academy">
        ...
        <section class="course-hero">
            <div class="course-hero-copy">
                <p class="eyebrow">DNL-Akademie</p>
                <h1>Vertiefungsausbildung</h1>
                <p class="course-lead">Aufbauend auf den Grundlagen vertieft diese Ausbildung die methodischen Kompetenzen in komplexen Beratungssituationen und strukturierter Gesprächsführung.</p>
                <div class="course-price"><strong>890 €</strong><span>einmalig · kein Abo</span></div>
                ...
                <a class="order-cta" href="{{ route('course.show', 'dnl-vertiefung') }}">Kurs im Mitgliederbereich öffnen <span>→</span></a>
            </div>
